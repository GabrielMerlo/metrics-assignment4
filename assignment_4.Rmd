...
## (a) ) Suppose now that (1) holds with "i independent of Di and Xi: What is the corresponding
quantile regression of Y given Xi
; Di associated to (1)? How would you test (visually) the
previous independence assumption using quantile regression